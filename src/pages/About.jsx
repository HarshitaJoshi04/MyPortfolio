...
const About = () => {
  ...
  return (
    <div className="relative w-full min-h-screen flex items-center justify-center py-12 md:py-24">
      ...
      >
        <div
          className={`w-full max-w-5xl flex flex-col gap-10 p-8 md:p-12 rounded-3xl border transition-all duration-500 ${
            isDark
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-10">
            ...
            <div className="w-full lg:w-1/2 flex justify-center items-center">
              <img 
                ...
                className="w-full max-w-[280px] sm:max-w-[320px] md:max-w-[350px] object-contain rounded-2xl shadow-lg border border-white/10"
              />
            </div>
          </div>

          {/* Divider */}
          <div className="w-full h-px bg-slate-200/10 border-b border-slate-200/10" />
